...
class AdapterMini: RecyclerView.Adapter<AdapterMini.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): AdapterMini.ViewHolder {
        val layoutInflater = LayoutInflater.from(parent.context)
        return ViewHolder(layoutInflater.inflate(R.layout.mini_card, parent, false))
    }

    override fun onBindViewHolder(holder: AdapterMini.ViewHolder, position: Int) {
